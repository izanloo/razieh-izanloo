...
$(document).ready(function () {
  //carousel1*************************************
  let WindowWidth = $("#slide-window").width();
...
function DoIt(target) {
  ...
  $(".home-a").hover(function () {
    $(".dropdown-home").addClass("d-block")
  });
   $(".book-new").hover(function () {
    $(".dropdown-home").addClass("book-new2")
  });
  $(".dropdown-home").mouseleave(function () {
    $(this).removeClass("d-block")
  });
  //animation-border-home
  $(".animations").hover(function () {
    $(this).addClass("border-animate");
  });
  //animation-border-allNavbar
  $('.navbar-center').find("a").hover(function (){
     $(this).addClass("border-animate");
    $(".home-a").removeClass("border-animate");
    $(".home-light").removeClass("border-animate");
